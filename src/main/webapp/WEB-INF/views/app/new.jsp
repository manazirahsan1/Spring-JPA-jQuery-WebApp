...
<title>Multi Level Authentication: New App</title>
</head>
<body>
<div class="container">
<div class="row">
	...
	<div class="col-sm-8">
		...
		<div class="jumbotron">
			<spring:url value="/apps/create" var="userActionUrl" />	
			<form class="form-horizontal" method="POST" action="${userActionUrl}" enctype="multipart/form-data">
				<h3 style="text-align:center">New App Form</h3><br/>				
				<div class="form-group row">
					<label class="col-sm-4 control-label text-right">Name</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="name" name="name" placeholder="Name of the app" autofocus />
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="description" name="description" placeholder="A short note" />
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						<a class="btn btn-secondary" href="/apps">Home</a>
					</div>	
				</div>
			</form>
		</div>
